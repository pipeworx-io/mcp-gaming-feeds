...
const FEEDS: Record<string, FeedDef> = {
  ...
  gamesindustry: { title: "GamesIndustry.biz", url: "https://www.gamesindustry.biz/feed", category: "gaming", source: "GamesIndustry.biz", description: "Video-game industry business news." },
};

const tools: McpToolExport['tools'] = [
  {
    name: 'list_feeds',
    description: 'List the curated gaming feeds (id, title, category, source). Optionally filter by category (gaming) or keyword. Pass an id to read_feed.',
    inputSchema: {
      type: 'object',
      properties: {
        category: { type: 'string', description: 'Filter by category: gaming.' },
  ...
  {
    name: 'read_feed',
    description: 'Read a curated gaming feed by its id (from list_feeds). Returns normalized items (title, link, published, summary). Optionally filter items by keyword.',
    inputSchema: {
      type: 'object',
      properties: {
